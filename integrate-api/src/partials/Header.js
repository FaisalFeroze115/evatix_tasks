          ...
          <nav className="flex flex-grow">
...

              {
                ...
                <ul className="flex flex-grow justify-end flex-wrap items-center">
                  <li>
                    <Link to="/profile" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">My Profile</Link>
                  </li>

                  <li>
                    <Link to="/update/profile" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Update Profile</Link>
                  </li>
